...
public class DiscountPage extends TestBase{
	...
	@FindBy(xpath = "//span[contains(text(), 'No of Discount Units')]/ancestor::visual-container[1]/..//visual-modern//*[local-name()='svg' and contains(@aria-label, 'New Discount_Count')]//*[local-name()='tspan']")
	WebElement noOfDiscountUnits;
	
	@FindBy(xpath = "//span[contains(text(), 'Total Discount Value')]/ancestor::visual-container[1]/..//visual-modern//*[local-name()='svg']//*[local-name()='tspan']")
	WebElement totalDiscountValue;
	
	@FindBy(xpath = "//*[@class='content text ui-role-button-text selected' and text() = 'Units']/ancestor::div[@class='contentOuterContainer']/..//*[@class='tileSVG']//*//*[@class='tile']//*[@class='fill ui-role-button-fill sub-selectable']")
