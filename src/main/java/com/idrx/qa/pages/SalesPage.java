...
public class SalesPage extends TestBase {
    ...
    @FindBy(xpath = "//[@class='tileSVG']//[@class='tile']")
    List<WebElement> bookingsButton;

    @FindBy(xpath = "//[@class='tileSVG']//[@class='tile']")
    List<WebElement> deliveryTab;
    ...
    public void clickBookingsTab() {
        WebElement bookingsTab = this.bookingsButton.get(1);
        bookingsTab.click();
    }

    public void clickDeliveryTab() {
        this.deliveryTab.get(3).click();
    }

    public void clickDiscountTab() {
        WebElement discountTab = this.menuTabs.get(5);
        discountTab.click();
    }

    public void clickFinanceTab() {
        WebElement financeTab = this.menuTabs.get(6);
        financeTab.click();
    }
