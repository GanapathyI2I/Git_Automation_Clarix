...
// int vehicleBookedYesterdayExpectedValue =
// Integer.parseInt(vehicleBookedYesterday);
// String vehicleBookedYesterdayVal = bookingsPage.getYesterdayBooking();
// int vehicleBookedYesterdayActualValue =
// Integer.parseInt(vehicleBookedYesterdayVal);
// testUtil.assertEquals(vehicleBookedYesterdayActualValue,
// vehicleBookedYesterdayExpectedValue, "No of Bookings Yesterday");
// }
...
// int vehicleBookedThisMonthExpectedValue =
// Integer.parseInt(vehicleBookedThisMonth);
// String vehicleBookedThisMonthVal = bookingsPage.getThisMonthBooking();
// int vehicleBookedThisMonthActualValue =
// Integer.parseInt(vehicleBookedThisMonthVal);
// testUtil.assertEquals(vehicleBookedThisMonthActualValue,
// vehicleBookedThisMonthExpectedValue, "No of Bookings This Month");
// }
...
// testUtil.assertEquals(pendingBookingsActualValue,
// pendingBookingsExpectedValue, "No of Pending Bookings");
// }
...
// testUtil.assertEquals(previousMonthActualValue, previousMonthExpectedValue,
// "No of Previous Month");
// }
...
// testUtil.assertEquals(currentMonthActualValue, currentMonthExpectedValue, "No
// of Current Month");
// }

// @Test(priority = 6, enabled=true)
// public void salesmanWisePendingBookingsTest() throws Exception {
// String salesmanWisePendingBookings =
// DBUtil.salesmanWisePendingBookingsTestDBValue();
// System.out.println("--------Bookings/Salesman Wise Pending
// Bookings--------");
// int salesmanWisePendingBookingsExpectedValue =
// Integer.parseInt(salesmanWisePendingBookings);
// String salesmanWisePendingBookingsVal =
// bookingsPage.getSalesmanWisePendingBookings();
// int salesmanWisePendingBookingsActualValue =
// Integer.parseInt(salesmanWisePendingBookingsVal);
// testUtil.assertEquals(salesmanWisePendingBookingsActualValue,
// salesmanWisePendingBookingsExpectedValue, "No of Salesman Wise Pending
// Bookings");
// }
