...
// testUtil.assertEquals(deliveryYesterdayActualValue,
// deliveryYesterdayExpectedValue, "No of Deliveries Yesterday");
// }
...
// testUtil.assertEquals(deliveryThisMonthActualValue,
// deliveryThisMonthExpectedValue, "No of Deliveries This Month");
// }
...
// testUtil.assertEquals(deliveryPendingActualValue,
// deliveryPendingExpectedValue, "No of Pending Deliveries");
// }
...
// int deliveryPreviousMonthExpectedValue =
// Integer.parseInt(deliveryPreviousMonth);
// String deliveryPreviousMonthVal = deliveryPage.getPreviousMonth();
// int deliveryPreviousMonthActualValue =
// Integer.parseInt(deliveryPreviousMonthVal);
// testUtil.assertEquals(deliveryPreviousMonthActualValue,
// deliveryPreviousMonthExpectedValue, "No of Deliveries Previous Month");
// }
...
// int deliveryCurrentMonthExpectedValue =
// Integer.parseInt(deliveryCurrentMonth);
// String deliveryCurrentMonthVal = deliveryPage.getCurrentMonth();
// int deliveryCurrentMonthActualValue =
// Integer.parseInt(deliveryCurrentMonthVal);
// testUtil.assertEquals(deliveryCurrentMonthActualValue,
// deliveryCurrentMonthExpectedValue, "No of Deliveries Current Month");
// }

// @Test(priority = 6, enabled=true)
// public void deliverySalesmanWisePendingTest() throws Exception {
// String deliverySalesmanWisePending =
// DBUtil.salesmanWisePendingDeliveriesTestDBValue();
// System.out.println("--------Delivery/Salesman Wise Pending
// Deliveries--------");
// int deliverySalesmanWisePendingExpectedValue =
// Integer.parseInt(deliverySalesmanWisePending);
// String deliverySalesmanWisePendingVal =
// deliveryPage.getSalesmanWisePendingDeliveries();
// int deliverySalesmanWisePendingActualValue =
// Integer.parseInt(deliverySalesmanWisePendingVal);
// testUtil.assertEquals(deliverySalesmanWisePendingActualValue,
// deliverySalesmanWisePendingExpectedValue, "No of Salesman Wise Pending
// Deliveries");
// }
