...
public class PayablesTest extends TestBase {
    ...
    public void getTotalPayablesTest() throws Exception {
        String payablesExpectedValue = DBUtil.totalPayablesGetDBValue();
        String totalPayablesExpectedValue = "₹ " + payablesExpectedValue;
    ...
    // testUtil.assertEquals(mahindraPayablesActualValue,
    // mahindraPayablesExpectedValue, "Total Payables");
    // }
    ...
    // testUtil.assertEquals(salesPayablesActualValue, salesPayablesExpectedValue,
    // "Sales Payables");
    // }
    ...
    // testUtil.assertEquals(servicePayablesActualValue,
    // servicePayablesExpectedValue, "Service Payables");
    // }
    ...
    // testUtil.assertEquals(sparesPayablesActualValue, sparesPayablesExpectedValue,
    // "Spares Payables");
    // }
    ...
    // testUtil.assertEquals(othersPayablesActualValue, othersPayablesExpectedValue,
    // "Others Payables");
    // }

    // @Test(priority = 7, enabled = true)
    // public void getGreaterThan60DaysPendingPayablesTest() throws Exception {
    // String greaterThan60DaysPendingPayablesExpectedValue =
    // DBUtil.greaterThan60DaysPendingPayablesGetDBValue();
    // System.out.println("--------Greater Than 60 Days Pending Payables--------");
    // System.out.println("Expected Value: " +
    // greaterThan60DaysPendingPayablesExpectedValue);
    // String greaterThan60DaysPendingPayablesActualValue =
    // payablesPage.getGreaterThan60DaysPendingPayables();
    // System.out.println("Actual Value: " +
    // greaterThan60DaysPendingPayablesActualValue);
    ...
    // String greaterThan30DaysPendingPayablesExpectedValue =
    // DBUtil.greaterThan30DaysPendingPayablesGetDBValue();
    // System.out.println("--------Greater Than 30 Days Pending Payables--------");
    // System.out.println("Expected Value: " +
    // greaterThan30DaysPendingPayablesExpectedValue);
    // String greaterThan30DaysPendingPayablesActualValue =
    // payablesPage.getGreaterThan30DaysPendingPayables();
    // System.out.println("Actual Value: " +
    // greaterThan30DaysPendingPayablesActualValue);
    ...
    public void currentMonthPayablesTrendTest() throws Exception {
        String payablesTrendExpectedValue = DBUtil.currentMonthPayablesTrendGetDBValue();
        String currentMonthPayablesTrendExpectedValue = "₹ " + payablesTrendExpectedValue;
    ...
    public void lastMonthPayablesTrendTest() throws Exception {
        String payablesTrendExpectedValue = DBUtil.lastMonthPayablesTrendGetDBValue();
        String lastMonthPayablesTrendExpectedValue = "₹ " + payablesTrendExpectedValue;
