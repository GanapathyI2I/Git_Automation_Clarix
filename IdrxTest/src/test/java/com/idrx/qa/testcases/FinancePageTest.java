...
public class FinancePageTest extends TestBase{
	...
	public void previousMonthFinanceTrendTest() throws Exception {
		...
		testUtil.assertEquals(previousMonthFinanceTrendActualValue, previousMonthFinanceTrendExpectedValue, "Previous Month Finance Trend");
	}
	...
	public void currentMonthFinancePenetrationTrendTest() throws Exception {
		...
		String currentMonthFinancePenetrationTrendExpectedValue = DBUtil.currentMonthFinancePenetrationTrendGetDBValue();
	...
	public void previousMonthFinancePenetrationTrendTest() throws Exception {
		...
		String previousMonthFinancePenetrationTrendExpectedValue = DBUtil.previousMonthFinancePenetrationTrendGetDBValue();
		...
		testUtil.assertEquals(previousMonthFinancePenetrationTrendActualValue, previousMonthFinancePenetrationTrendExpectedValue, "Previous Month Finance Penetration Trend");
	}
